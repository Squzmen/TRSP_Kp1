[загружено.csv](https://github.com/user-attachments/files/25517341/default.csv)# Контрольная работа №1 — FastAPI
...
[U"Задание","Метод","Маршрут","Описание"
"1.1","GET","/","Возвращает JSON-приветствие"
"1.2","GET","/","Возвращает HTML-страницу (заменяет 1.1)"
"1.4","GET","/users","Возвращает данные пользователя"
"2.1","POST","/feedback","Принимает отзыв, сохраняет в список"ploading загружено.csv…]()
